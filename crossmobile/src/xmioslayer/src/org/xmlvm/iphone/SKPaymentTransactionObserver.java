...
public abstract class SKPaymentTransactionObserver extends NSObject {
    ...
    public abstract void updatedTransactions(SKPaymentQueue queue, ArrayList<SKPaymentTransaction> transactions);

    public void removedTransactions(SKPaymentQueue queue, ArrayList<SKPaymentTransaction> transactions) {
    }
